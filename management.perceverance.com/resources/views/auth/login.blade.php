              ...
              <div class="form d-flex align-items-center">
                ...
                @endif
                  ...
                  <form method="post"  action="{{ route('login')}}" class="form-validate">
                    ...
                    <a href="#" class="forgot-pass">Forgot Password?</a><br><small>Do not have an account? </small><a href="{{url('/register')}}" class="signup">Signup</a>
    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="name" class="block mt-1 w-full" type="email" name="name" :value="old('name')" required autofocus autocomplete="username" />
            </div>
