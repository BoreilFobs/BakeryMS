              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar">
                    ...
                    <div class="order dashbg-4">3d</div>
                  </div>
                  <a href="{{url('/employees/1/profile')}}" class="user-title">
                    <span>More About</span>
                    <h3 class="h5">Sebastian Wood</h3>
                  </a>
                  <div class="contributions">Patissier</div>
                  <div class="details d-flex align-item-around">
                    <div class="item">
                      <i class="icon-info"></i><strong>15 ans</strong>
                    </div>
                    <div class="item">
                      <strong>5 years experience</strong>
                    </div>
                    {{-- <div class="item">
                      <i class="icon-flow-branch"></i><strong></strong>
                    </div> --}}
                  </div>
                </div>
              </div>
